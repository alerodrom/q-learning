    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_related', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='qlearning_app.Map')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='qlearning_app.Problem')),
            ],
            options={
                'verbose_name': 'result',
